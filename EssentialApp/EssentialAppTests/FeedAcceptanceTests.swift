...
class FeedAcceptanceTests: XCTestCase {
	...
	private func makeData(for url: URL) -> Data {
        ...
        case "/essential-feed/v1/feed" where url.query?.contains("after_id=166FCDD7-C9F4-420A-B2DC-CE2EAFA3D82F") == true:
    ...
    private func makeSecondFeedPageData() -> Data {
        return try! JSONSerialization.data(withJSONObject: ["items": [
            ["id": "166FCDD7-C9F4-420A-B2DC-CE2EAFA3D82F", "image": "http://feed.com/image-2"]
